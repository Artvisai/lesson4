maxWeight = 20
inventory = {'default': 0}
"""Создает игровой инвентарь. Добавляет в него предметы и удаляет их из него.
Инвентарь ограничен по весу. Выводит предметы с его названием и весом."""

def isOverloaded(a):
    """Проверяет, не переполняет ли заявленный предмет инвентарь"""
